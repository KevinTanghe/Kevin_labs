        ...
        <div class="row mt-5">
            ...
            <div class="col-9 bg-secondary p-5 text-white">
                <div class="container">
                    ...
                    @endif
                    <form action="/subject/{{$edit->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
                            <label for="">Sujet</label>
                            <input class="form-control" name="subject" value="{{old('subject') ? old('subject') : $edit->subject}}" type="text">
                        </div>
