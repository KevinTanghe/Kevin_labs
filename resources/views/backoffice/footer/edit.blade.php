                ...
                <div class="container">
                    ...
                    <form action="/footer/{{$edit->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="content" value="{{old('content') ? old('content') : $edit->content}}" type="text">
                        </div>
                        <div class="form-group">
                            <label for="">Url</label>
                            <input class="form-control" name="url" value="{{old('url') ? old('url') : $edit->url}}" type="text">
                        </div>
                        <div class="form-group">
                            <label for="">Nom de l'URL</label>
                            <input class="form-control" name="name" value="{{old('name') ? old('name') : $edit->name}}" type="text">
                        </div>
